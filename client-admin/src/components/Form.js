export default function ReactForm () {
  ...
  <>
    <form action="" class="flex flex-col w-60 gap-5 mx-5">
      ...
      <input type="text" class="px-3 py-2 shadow-md rounded-md" placeholder="Main Image" />
      <input type="text" class="px-3 py-2 shadow-md rounded-md" placeholder="2nd Image" />
      <input type="text" class="px-3 py-2 shadow-md rounded-md" placeholder="3rd Image" />
      <input type="text" class="px-3 py-2 shadow-md rounded-md" placeholder="4th Image" />
